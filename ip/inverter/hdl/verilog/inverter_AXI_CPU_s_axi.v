...
#(parameter
    ...
    input  wire [9:0]                    in_r_address0,
    input  wire                          in_r_ce0,
    output wire [7:0]                    in_r_q0,
    input  wire [9:0]                    out_r_address0,
...
localparam
    ...
    ADDR_IER        = 12'h008,
    ADDR_ISR        = 12'h00c,
    ADDR_IN_R_BASE  = 12'h400,
    ADDR_IN_R_HIGH  = 12'h7ff,
...
assign int_in_r_address1  = ar_hs? raddr[9:2] : waddr[9:2];
