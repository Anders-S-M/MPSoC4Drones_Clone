...
architecture behave of inverter_AXI_CPU_s_axi is
    ...
    constant ADDR_IN_R_BASE  : INTEGER := 16#400#;
    constant ADDR_IN_R_HIGH  : INTEGER := 16#7ff#;
    ...
    -- memory signals
    signal int_in_r_address0   : UNSIGNED(7 downto 0);
    ...
    signal int_in_r_address1   : UNSIGNED(7 downto 0);
...
-- ----------------------- Memory logic ------------------
    -- in_r
    int_in_r_address0    <= SHIFT_RIGHT(UNSIGNED(in_r_address0), 2)(7 downto 0);
    ...
    int_in_r_address1    <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
    ...
    -- out_r
    int_out_r_address0   <= SHIFT_RIGHT(UNSIGNED(out_r_address0), 2)(7 downto 0);
